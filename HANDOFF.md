...
最終更新: 2026-06-10（連載別一覧ページ `/series/[slug]` を新設＝項目34。連載名・カテゴリー帯・「小商店」画像のリンク先。記事ページの足跡／カテゴリー帯からも連載ページへ飛べるよう配線。あわせて SAKIさんと対話しながら文字サイズ微調整＝カテゴリー帯の連載名16px・記事一覧カードのタイトル12.8px。ブラウザ動作確認済み。前提として項目33で記事詳細ページの前後ナビ・関連記事を仕上げ。切替時期は7月下旬 or 8月末を検討中）
