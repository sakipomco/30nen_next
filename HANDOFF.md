...
最終更新: 2026-06-10（月別アーカイブページ `/archive/[ym]` を新設＝項目36。アーカイブ目次がクリックで月別ページに飛ぶようになり、右コラムの3点セット＝小商店・ワード検索・アーカイブがすべて機能。同日に ワード検索の完成＝項目35（`/search`・枠線フォーム・足跡フォントをZen角ゴシックNewに・タブのタイトル二重修正・「アキは揃える」ポリシー明文化）。残る大物は about・左端メニューの固定ページ群。切替時期は7月下旬 or 8月末を検討中）
