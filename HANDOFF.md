...
最終更新: 2026-06-12（「当店について」ページ `/about` を新設＝項目37。現行 30nen.com/about/ を忠実再現し、左端メニュー「当店について」「書き手募集(#wanted)」・「三十年商店とは？」ボタンがすべて機能。残る固定ページは 沿革・利用規約・プライバシーポリシー。切替時期は7月下旬 or 8月末を検討中）
