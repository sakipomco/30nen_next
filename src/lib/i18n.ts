...
const dict = {
  ...
  'admin.newArticle': { ja: '新しい日記をかく', es: 'Escribir nuevo diario' },
  ...
  // ── 記事フォーム ────────────────────────────────
  'article.newTitle': { ja: '新しい日記をかく', es: 'Escribir nuevo diario' },
  ...
  'image.fromDevice': { ja: '画像をデバイスから選ぶ', es: 'Seleccionar imagen del dispositivo' },
  'image.fromFolder': { ja: '画像フォルダから選ぶ', es: 'Seleccionar de la carpeta de imágenes' },
  ...
  'editor.imageFromDevice': { ja: '画像をデバイスから選ぶ', es: 'Seleccionar imagen del dispositivo' },
  'editor.imageFromFolder': { ja: '画像フォルダから選ぶ', es: 'Seleccionar de la carpeta' },
