      ...
      {open && (
        <div className="fixed inset-0 z-[110] overflow-y-auto bg-white px-6 pb-28 pt-10">
          ...
          <Link
            href="/about"
            onClick={close}
            className="serif mx-auto mb-10 flex w-36 items-center justify-center rounded-full bg-[#eeeeee] py-0.5 text-xs leading-tight text-[#333] transition-colors hover:bg-[#150c0c] hover:text-white"
          >
            三十年商店とは？
          </Link>
